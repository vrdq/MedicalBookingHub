                ...
                <TableBody>
                  {filtered.map((doctor) => (
                    <TableRow key={doctor.id}>
                      ...
                      <TableCell>
                        <div className="font-medium capitalize">{({ psychiatrist: t("reg_psychiatrist"), psychologist: t("reg_psychologist") } as Record<string,string>)[doctor.type] ?? doctor.type}</div>
                      ...
                      <TableCell>
                        ...
                        <div className="text-xs text-muted-foreground capitalize">{({ individual: t("docs_individual"), group: t("docs_group"), both: t("profile_sessionBoth") } as Record<string,string>)[doctor.sessionType] ?? doctor.sessionType}</div>
                      </TableCell>
                      <TableCell>
                                ...
                                <div className="space-y-6">
                                  <div className="flex items-center gap-4 border-b pb-4">
                                    ...
                                    <div className="flex-1">
                                      ...
                                      <div className="flex flex-col gap-1 mt-1 text-sm text-muted-foreground">
                                        ...
                                        <div className="flex items-center gap-2"><Briefcase className="w-3.5 h-3.5" /> {({ psychiatrist: t("reg_psychiatrist"), psychologist: t("reg_psychologist") } as Record<string,string>)[doctor.type] ?? doctor.type}</div>
                                      </div>
                                    </div>
                                    {doctor.pendingAvatarUrl && (
                                  ...
                                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-1">
                                      ...
                                      {doctor.pendingLanguages && doctor.pendingLanguages.length > 0 && (
                                        <div className="mt-2 p-2 bg-amber-50 rounded border border-amber-100">
                                          <div className="text-[10px] font-bold text-amber-700 uppercase">
                                            {t("admin_pendingChanges")}
                                          </div>
