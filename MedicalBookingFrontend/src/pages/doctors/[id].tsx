              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <div className="text-muted-foreground capitalize">{({ individual: t("docs_individual"), group: t("docs_group"), both: t("profile_sessionBoth") } as Record<string,string>)[doctor.sessionType] ?? doctor.sessionType}</div>
                  </div>
                  <div>
